...
full_list[0].append("Curtis")
full_list[1].append("Melissa")

# Print statements
print(full_list)
print("Just the heroes:", full_list[0])
print("Just the villains:", full_list[1])
print("Second character from the first list:", full_list[0][1])  # "Captain America"
print("Last character from the last list:", full_list[1][2])  # "Ultron"
